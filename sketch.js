...
function setup() {
 createCanvas(600,450);
  ...
  backround = createSprite(200,250,6000,2000);
...
bird.velocityX =0
 if ( mousePressedOver(restart)) {
  ...
  drawSprites();
  textSize(23)
  text("score"+score,bird.x,50);
}

function spawnMeteor(){
 if (frameCount % 60 === 0){
   var meteor = createSprite(bird.x+300,Math.round(random(100,400)),50,50)
...
function spawnHeli(){
 if (frameCount % 50 === 0){
   var helicopter = createSprite(bird.x+300,Math.round(random(100,400)),50,50)
...
function spawnDragon(){
 if (frameCount % 120 === 0){
   var dragon = createSprite(bird.x+300,Math.round(random(100,400)),50,50)
